def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="Number of candidate sequences. Only for seq_optimization",
    )
    parser.add_argument(
        "--selection_mode",
        type=str,
        default="soft",
        help="Selection mode: hard or soft. Only for seq_optimization",
        choices=["hard", "soft"],
    )
    parser.add_argument(
        "--protected_regions",
        type=str,
        default="",
        help="Protected regions (e.g., '1,4,9,13'). Only for seq_optimization",
    )
    parser.add_argument(
        "--elitism_ratio",
        type=float,
        default=0.2,
        help="Elitism ratio. Only for seq_optimization",
    )
    parser.add_argument(
        "--model_weight",
        type=str,
    ...
    match args.mission:
        ...
        case "seq_optimization":
            infer_seq_optimization(
                ...
                protected_regions=args.protected_regions,
